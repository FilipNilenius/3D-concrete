 function [B,detJ,wp]=computeBmatrixElasticity(ex,ey,ez,ep)
...
%--------- three dimensional case ----------------------------
  for i=1:ngp
    ...
    B.ngp(1,1:3:24-2)=dNx(1,:);
    B.ngp(2,2:3:24-1)=dNx(2,:);
    B.ngp(3,3:3:24)  =dNx(3,:);
    B.ngp(4,1:3:24-2)=dNx(2,:);
    B.ngp(4,2:3:24-1)=dNx(1,:);
    B.ngp(5,1:3:24-2)=dNx(3,:);
    B.ngp(5,3:3:24)  =dNx(1,:);
    B.ngp(6,2:3:24-1)=dNx(3,:);
    B.ngp(6,3:3:24)  =dNx(2,:);
    B.gaussPoint(1+6*(i-1):6*i,:) = B.ngp;
    B.tot = B.tot + B.ngp;
  end
%--------------------------end--------------------------------
